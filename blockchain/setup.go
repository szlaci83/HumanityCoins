...
func (setup *FabricSetup) InstallAndInstantiateCC() error {
	...
	err = setup.admin.InstantiateCC(setup.ChannelID, resmgmt.InstantiateCCRequest{Name: setup.ChainCodeID, Path: setup.ChaincodePath, Version: "1.0", Args: [][]byte{}, Policy: ccPolicy})
	if err != nil {
